    ...
    return (
        <div >
                ...
                <div style={{textAlign: 'center'}}>
                    <textarea  className={`my-2 text-${props.textFormTheme.textColor}`} style={{backgroundColor: props.textFormTheme.backgroundColor,}} value={text} id="myBox" rows="8" cols="150" onChange={onChangeHandler}></textarea> <br />
